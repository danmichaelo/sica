...
.selectize-control .conceptType, .selectize-control .matchedLabel {
    opacity: 0.8;
}
.selectize-control .prefLabel + .conceptType {
    margin-left: 5px;
}
.selectize-control .conceptType:before {
    content: '(';
}
.selectize-control .conceptType:after {
    content: ')';
}
        ...
        <div class="container">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="{{ url('/') }}">
                    SICA <!-- Subject Indexing and Classification tool for Alma -->
                </a>
            </div>
